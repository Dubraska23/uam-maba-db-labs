...
Ve a: https://www.gov.uk/government/statistical-data-sets/price-paid-data-downloads
Descarga los archivos "Yearly file" para 2025 y 2024 (y opcionalmente 2023 para verificar funcionamiento del Auto Loader).
Sube los archivos al entorno Databricks a workspace/uk_housing/ingestion
...
Abre y ejecuta 01_data_ingestion_exploration.ipynb para explorar y transformar los datos hasta la capa Bronze.
Continúa con 02_data_cleaning_transformation.ipynb para crear Silver y Gold.
Utiliza 03_transformations.ipynb para crear las tablas Gold.
Realiza análisis SQL con 04_sql_analysis.ipynb.
Presenta visualizaciones y dashboards con 05_dashboard_summary.ipynb.
Opcional: ejecuta 06_model_data.ipynb para generar el dataset para emtrenar un modelo predictivo.
